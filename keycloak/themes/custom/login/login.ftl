...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "form">
        <div>
            <img class="logo" src="${url.resourcesPath}/img/logo192.png" alt="askme" height=30>
            <p class="application-name">${msg(realm.displayName!'')}</p>
        </div>
        ...
        <#if social.providers??>
            <p class="para">OR Sign In Using </p>
